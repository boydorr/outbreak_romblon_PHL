...
### trees
# time scaled
all_phl.tree.time=read.beast("processed_data/dated_trees/all_wgsrate_lsd_CI.date.nexus")
# substitution scaled
all_phl.tree.subs=read.newick("processed_data/trees/all_rooted.nwk")
