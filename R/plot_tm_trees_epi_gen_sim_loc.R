...
# filter trees to those for scenario: epi + gen data / simulated locations / unpruned
links_consensus <- links_consensus[scenario == 4]
ttrees <- ttrees[scenario == 4]
...
links_consensus %>%
  ...
  arrange(id_case) %>%
  fwrite(here("output/figures/epi_gen_simulated_locations_unpruned/constree_epigen_unpruned_simlocs_chainids.csv"))
...
tree_col_by_membership_no_unsampled_nodes <- 
  plot_lin_ts(links_consensus, case_dates,
              ...
              id_labels = FALSE,
              timeline_breaks = 3)
ggsave(here("output/figures/epi_gen_simulated_locations_unpruned/constree_epigen_unpruned_simlocs_nonodes.jpeg"), tree_col_by_membership_no_unsampled_nodes, height = 8, width = 8)
...
tree_col_by_membership_id_labels <- 
  plot_lin_ts(links_consensus, case_dates,
              ...
              id_labels = TRUE,
              timeline_breaks = 3)
ggsave(here("output/figures/epi_gen_simulated_locations_unpruned/constree_epigen_unpruned_simlocs_idlabels.jpeg"), tree_col_by_membership_id_labels, height = 8, width = 8)
...
tree_col_by_membership_grey_edges <- 
  plot_lin_ts(links_consensus, case_dates,
              ...
              id_labels = NA,
              timeline_breaks = 3)
ggsave(here("output/figures/epi_gen_simulated_locations_unpruned/constree_epigen_unpruned_simlocs_greyedges.jpeg"), tree_col_by_membership_grey_edges, height = 8, width = 8)
...
epicurve <- plot_epicurve(links_consensus, case_dates,
                          colour_by = "lineage_chain",
                          timeline_breaks = 3)
ggsave(here("output/figures/epi_gen_simulated_locations_unpruned/epicurve_consensus_epigen_unpruned_simlocs.jpeg"), epicurve, height = 8, width = 8)
...
map_w_cases <- plot_map_w_lin_cases(links_consensus, case_coords = case_data,
                                    map = Romblon_shp,
                                    colour_by = "lineage_chain")
ggsave(here("output/figures/epi_gen_simulated_locations_unpruned/map_consensus_epigen_unpruned_simlocs.jpeg"), map_w_cases, height = 8, width = 8)
...
ggsave(here("output/figures/epi_gen_simulated_locations_unpruned/consensus_epicurve_trees_map.jpeg"), tm_trees_main_figure, height = 8, width = 8)
...
saveVideo({ 
  ...
  video.name = here("output/figures/epi_gen_simulated_locations_unpruned/tmtree_animation.mp4"),
